...
import pl.btbw.core.common.input.FormProvider;
...
import pl.btbw.core.product.form.InfoForm;
...
public class ProductController {
	...
	public Component componentAuthor(@PathVariable("id") long id) {
		return ComponentProvider
				.on(productRepository.getOne(id))
